        ...
        if not ret_val:
            ...
            if len(p0) <= 10:
                ...
                if len(faces) != 0:
                    ...
                    x_upperleft, y_upperleft, width, height = faces[0]  # replace me
                    roi_gray = gray[y_upperleft:y_upperleft + height, x_upperleft:x_upperleft + width] # replace me
                    ##-your-code-ends-here-##
                ...
                ##-your-code-starts-here-##
                new_point = p1[isFound.flatten() == 1]
                old_point = p0[isFound.flatten() == 1]
                ##-your-code-starts-here-##
                
                # Draw points using e.g. cv2.drawMarker
                ##-your-code-starts-here-##
                for new, old in zip(new_point, old_point):
                    x, y = new.ravel()
                    cv2.drawMarker(img, (int(x), int(y)), color=(0, 255, 0), markerType=cv2.MARKER_CROSS)
                ##-your-code-ends-here-##
